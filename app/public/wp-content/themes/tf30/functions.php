...
function my_script_init()
{
  ...
  if (is_singular()) {
    wp_enqueue_style('highlight', get_template_directory_uri() . '/css/agate.css', array(), '1.0.0', 'all');
    wp_enqueue_script('highlight', get_template_directory_uri() . '/js/highlight.pack.js', array(), '1.0.0', true);
 ...
 * カテゴリーを1つだけ表示
 *
 * @param boolean $anchor aタグで出力するかどうか.　true:リンク付きで出力 false:カテゴリー名のみ出力
